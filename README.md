...
- 单一工作区根目录、PostgreSQL 逻辑备份、完整配置树与附件快照、SHA-256 校验和，以及恢复到新空目录和新空数据库的命令。
- 附件流式上传和下载：通用文件最大 50 MiB、书籍封面最大 5 MiB；PDF 等支持 Range，不会由 API 一次性读入内存。
...
- [06-物品记录功能设计文档](docs/06-物品记录功能设计文档.md)
